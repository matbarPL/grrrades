...
- **The Rockstars** have been depicted as the students that either are the gifted ones and pass both subjects consequently or after failing both previously now passed both of them.
...
- With the **Accepting trade-off** cluster the students that sacrifice one subject for the sake of the other were described.
...
Our assumptions were mostly correct and are confirmed with the graph. Students that want to continue their education
